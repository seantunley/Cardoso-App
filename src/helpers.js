...
export function defaultPermissionsForRole(role) {
  if (role === 'admin') {
    return {
      ...
      can_access_inventory_movement: true,
      can_access_price_list: true,
      ...
      can_access_stock_take: true,
      can_supervise_stock_take: true,
      can_access_creditors: true,
      can_access_commission: true,
      can_access_monthly_reports: true,
  ...
  return {
    ...
    can_access_collections: true,
    can_access_inventory: true,
    can_access_inventory_movement: false,
    can_access_price_list: false,
    ...
    can_access_stock_take: false,
    can_supervise_stock_take: false,
    can_access_creditors: false,
    can_access_commission: false,
    can_access_monthly_reports: false,
...
export function sanitizeUser(user) {
  ...
  return {
    ...
    can_access_inventory_movement: boolFromRow(user.can_access_inventory_movement, false),
    can_access_price_list: boolFromRow(user.can_access_price_list, false),
    ...
    can_access_stock_take: boolFromRow(user.can_access_stock_take, false),
    can_supervise_stock_take: boolFromRow(user.can_supervise_stock_take, false),
    ...
    can_access_monthly_reports: boolFromRow(user.can_access_monthly_reports, false),
