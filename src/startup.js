...
export async function ensureSeedUsers() {
  ...
  if (!admin) {
    ...
    db.prepare(`
      INSERT INTO "user" (
        ...
        can_access_stock_receipt_expiry, can_access_stock_take, can_supervise_stock_take, can_access_creditors, can_access_commission, can_access_monthly_reports,
    ...
    `).run(
      ...
      adminDefaults.can_access_stock_take ? 1 : 0,
      adminDefaults.can_supervise_stock_take ? 1 : 0,
  ...
  if (!normal) {
    ...
    `).run(
      ...
      userDefaults.can_access_stock_take ? 1 : 0,
      userDefaults.can_supervise_stock_take ? 1 : 0,
