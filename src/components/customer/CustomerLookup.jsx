              ...
              const renderTransactionTable = ({ title, icon: Icon, iconColor, accounts, getFields }) => (
                <div className="rounded-xl border border-gray-700 bg-gray-800 p-4 flex-1 min-w-0">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="grid grid-cols-[minmax(0,0.8fr)_minmax(0,1.3fr)_minmax(0,1.4fr)_minmax(0,1fr)] gap-2 text-[10px] text-gray-500 uppercase tracking-wide px-1">
                      <span>Account</span>
                      <span>No.</span>
                      <span>Amount</span>
                      <span>Date</span>
                    ...
                    {accounts.map(({ label, record: r, isMain }) => {
                      ...
                      return (
                        <div
                          key={label}
                          className={cn(
                            "grid grid-cols-[minmax(0,0.8fr)_minmax(0,1.3fr)_minmax(0,1.4fr)_minmax(0,1fr)] gap-2 rounded-lg px-2 py-1.5",
                            isMain ? "bg-gray-700" : "bg-gray-900"
                          )}
                        >
                          <span className={cn("text-xs font-medium truncate", isMain ? "text-white" : "text-gray-400")}>
