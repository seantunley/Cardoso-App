    ...
    try {
      ...
      const info = db.prepare(`
        INSERT INTO "user" (
          ...
          can_access_jti, can_access_stock_receipt_expiry, can_access_stock_take, can_supervise_stock_take, can_access_creditors, can_access_commission, can_access_monthly_reports,
      ...
      `).run(
        ...
        defaults.can_supervise_stock_take ? 1 : 0,
